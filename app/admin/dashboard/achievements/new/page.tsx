...
export default function NewAchievementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Saving achievement data to achievements.json:", achievementData)
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Add New Achievement</h1>
          <p className="text-gray-600 dark:text-gray-400">Add a new achievement to your portfolio</p>
        </div>
